    ...
    <section className="bg-gray-100 py-16 lg:py-24 w-full relative z-10" aria-label="New Approach & Stats">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="bg-white rounded-[2.5rem] shadow-xl mx-auto max-w-6xl overflow-hidden border border-gray-200">
          ...
          {/* Bloque Superior: Contenido + Imagen */}
          <div className="flex flex-col lg:flex-row items-stretch min-h-[400px]">
            ...
            <div className="flex-1 p-8 md:p-12 lg:p-16 flex flex-col justify-center">
              ...
              <h2 className="font-title text-slate-900 text-3xl lg:text-4xl font-bold mb-5 leading-tight text-left">
                Our economy demands a <br className="hidden lg:block" /> new approach
              </h2>

              <p className="font-sans text-gray-600 text-[15px] lg:text-[16px] leading-relaxed mb-8 max-w-md text-left">
            ...
            {/* Imagen de la chica (Derecha) */}
            <div className="flex-1 relative min-h-[300px] lg:min-h-full">
              <Image
                src="/image-girl.png" 
                alt="Rebel member"
                fill
                className="object-cover lg:object-contain object-center lg:object-bottom"
